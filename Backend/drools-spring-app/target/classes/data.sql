...
insert into member(member_pkey, banned, membership_expired, can_rent) values(1, false, true, true);
...
insert into member(member_pkey, banned, membership_expired, can_rent) values(2, false, true, true);
...
insert into member(member_pkey, banned, membership_expired, can_rent) values(3, false, true, true);

insert into user_table(username, password, first_name, last_name, email, user_type) values('guest4', 'guest', 'guest', 'guest','guest', 0);
insert into member(member_pkey, banned, membership_expired, can_rent) values(4, false, true, true);

insert into user_table(username, password, first_name, last_name, email, user_type) values('guest5', 'guest', 'guest', 'guest','guest', 0);
insert into member(member_pkey, banned, membership_expired, can_rent) values(5, false, true, true);
